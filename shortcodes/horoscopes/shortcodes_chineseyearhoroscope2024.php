...
function chineseyearhoroscope2024(){
...
?>
    <style>
        ...
        @media (max-width: 767px) {
            #chineseyear2024_primescreen .col-lg-2 {
                flex-basis: 50%;
                max-width: 50%;
            }
        }
        ...
        <?php
            ...
            $product_id_to_fetch = 67; // Fetch images for product_id 7
            ...
            $product_details = get_product_details(67);
        ...
        <div class="container mb-5 mt-5" style="width:100%;padding:0" id="chineseyear2024container" style="display:none">
            <div class="row" id="chineseyear2024_maincontainer">
                <div class="col-md-12">
                    <div class="defaulttextcontainer_chineseyearhoroscope2024">    
                        <div style="font-size: 35px;" class="headersize_chineseyearhoroscope theme_color_chineseyearhoroscope2024" id="headtext"><strong><?php echo $product_details['consumer_title']; ?></strong></div>
                        <div class="text_color_chineseyearhoroscope2024 mt-3 textsize_chineseyearhoroscope2024"><?php echo $product_details['consumer_text1']; ?></div>
                        <div id="leadingtext" class="textsize_chineseyearhoroscope2024 font_birth mt-3 text_color_chineseyearhoroscope2024"><?php echo $product_details['consumer_text2']; ?></div> 
                    </div>
                    <div class="accordion" style="margin-top:20px;">
                        <div class="accordion-header mt-3 theme_color_chineseyearhoroscope2024"><b>Als je je Chinese teken niet weet, dan kun je dat eerst laten berekenen door hier te klikken.</b></div>
                        <div class="accordion-content text_color_chineseyearhoroscope2024 mt-3 textsize_chineseyearhoroscope2024">
                            <div id="container">
                                <h3 class="text_color_chineseyearhoroscope2024">Wat is je Chinese teken?</h3>
                                <p class="text_color_chineseyearhoroscope2024">Geef je geboortedatum:</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-2 mt-2" style="padding-right:0">
                                        <button onclick="calcsign()" class="btn background_chineseyearhoroscope2024 "><b style="color:white">BEREKEN</b></button>
                                    </div> 
                                </div>

                                <div class="mt-3">
                                    <input id="formteken" type="text" size="10" class="formGroep astro_chinese_year_horoscope2024" placeholder="Jouw jaardier is..." style="width:230px;border-radius:10px;">
                                </div>
                ...
                <div class="col-md-12" id="chineseyear2024_primescreen">
                    <div class="row">
                        ...
                        <?php
                            ...
                            foreach ($zodiacs as $zodiac_name => $image_path) {
                                ...
                                echo '    <div class="card shadower  background_gradient_chineseyearhoroscope2024" style="cursor:pointer" onclick="startpayment(\'' . $zodiac_name . '\')">';
                                ...
                                echo '            <div style="font-weight:bold" class="textsize_chineseyearhoroscope2024 font text_color_chineseyearhoroscope2024">' . ucfirst($zodiac_name) . '</div>';
                                echo '        </div>';
                                echo '    </div>';
                                echo '</div>';
                            }
                ...
                <div class="col-12 text-center" id="chineseyear2024_loader" style="display:none">
            ...
            <div id="chineseyearhoroscope2024_box" style="max-height:500px;overflow-y:auto;display:none;border-radius:10px;margin-top:20px;margin-bottom:20px;" class="row">
                <div style="border-radius:10px;">
                    <div class="theme_color_chineseyearhoroscope2024 text-center headersize_chineseyearhoroscope mt-2" style="font-size:25px;!important;text-weight:bold">Je chinese jaarhoroscoop is klaar!</div>
                    <div class="col-md-6 offset-4 textsize_chineseyearhoroscope2024 text_color_chineseyearhoroscope2024 mt-3">Bekijk deze nu via onderstaande knop:</div>
                    <div class="row">
                        <div class="col-md-10 text-end mt-4">
                            <a  href="" target="_blank" id="resultbutton_chineseyearhoroscope2024" class="textsize_chineseyearhoroscope20242024 font btn btn-outline text_color_chineseyearhoroscope" style="width:80%;">
                                <span class="textsize_chineseyearhoroscope2024" style="color:white!important;">BEKIJK DE CHINESE JAARHOROSCOOP</span>
                            </a>
                        </div> 
                        <div class="col-md-2 mt-4">
                            <button type="button" onclick="location.reload();" id="resultbutton_chineseyear" class="btn btn-outline-dark" style="width:50%">
                            <span class="textsize_chineseyearhoroscope2024"><i class="fa-solid fa-rotate-right fa2x"></i></span>
                            </button>
                        </div>                    
                    </div>
                </div>
        ...
        <script>
            ...
            function reset_chineseyear(){
                ...
                jQuery('#chineseyearhoroscope2024_box').hide();
                jQuery('#chineseyearhoroscope2024_box').css('opacity', '0');
                jQuery('#chineseyearhoroscope2024_box').css('display', 'none');
                jQuery('#chineseyear2024_primescreen').show();
            }
            ...
            jQuery(document).ready(function() {
                ...
                getsettings(
                    ...
                    token,
                    67, 
                    'chineseyearhoroscope2024', 
                    'chineseyear2024container', 
                    'font_chineseyear', 
                );
            });
            ...
            function startpayment(attribute){
                ...
                myService().getUrl().then(function(url) {
                    ...
                    var returlurl = 'https://astromedia-business.nl/return?t=' + token + '&attr=' + attribute + '&host=' + host + '&pid=' + 67;
            ...
            jQuery("#resultbutton_chineseyearhoroscope2024").on('click', function() {
...
<?php
    ...
    add_shortcode('astro_chinese_year_horoscope2024', 'chineseyearhoroscope2024');
?>