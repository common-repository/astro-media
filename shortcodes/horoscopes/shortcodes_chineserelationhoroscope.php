...
function chineserelationhoroscope(){
...
?>
    <style>
        ...
        @media (max-width: 767px) {
            #chineserelation_primescreen .col-lg-2 {
                flex-basis: 50%;
                max-width: 50%;
            }
        }
        ...
        <?php
            ...
            $product_id_to_fetch = 21; // Fetch images for product_id 7
            ...
            $product_details = get_product_details(21);
        ...
        <div class="container mb-5 mt-5" style="width:100%;padding:0" id="chineserelationcontainer" style="display:none">
            <div class="row" id="chineserelation_maincontainer">
                <div class="col-md-12">
                    <div class="defaulttextcontainer_chineserelationhoroscope">
                        <div style="font-size: 35px;" class="headersize_chineserelation theme_color_chineserelationhoroscope" id="headtext"><strong><?php echo $product_details['consumer_title']; ?></strong></div>
                        <div class="text_color_chineserelationhoroscope mt-3 textsize_chineserelationhoroscope"><?php echo $product_details['consumer_text1']; ?></div>
                        <div id="leadingtext" class="textsize_chineserelationhoroscope font_birth mt-3 text_color_chineserelationhoroscope"><?php echo $product_details['consumer_text2']; ?></div> 
                    </div>
                    <div class="accordion" style="margin-top:20px;">
                        <div class="accordion-header mt-3 theme_color_chineserelationhoroscope"><b>Als je je Chinese teken niet weet, dan kun je dat eerst laten berekenen door hier te klikken.</b></div>
                        <div class="accordion-content text_color_chineserelationhoroscope mt-3 textsize_chineserelationhoroscope">
                            <div id="container">
                                <h3 class="text_color_chineserelationhoroscope">Wat is je Chinese teken?</h3>
                                <p class="text_color_chineserelationhoroscope">Geef je geboortedatum:</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-2 mt-2" style="padding-right:0">
                                        <select name="formm" class="form-control" style="width:100%;background-position-x: calc( 100% - 10px );background-position-y: 50%;">
                                    ...
                                    <div class="col-12 col-lg-2 mt-2" style="padding-right:0">
                                        <select name="formj" class="form-control" style="background-position-x: calc( 100% - 10px );background-position-y: 50%;">
                                            <?php 
                                    ...
                                    <div class="col-12 col-lg-2 mt-2" style="padding-right:0">
                                        <button onclick="calcsign()" class="btn background_chineserelationhoroscope">BEREKEN</button>
                                    </div> 
                                </div>
                ...
                <div class="col-md-12" id="chineserelation_primescreen">
                    <div class="" style="">
                        <div class="">
                            <div style="font-weight:bold" class="text_color_chineserelationhoroscope col-12 text-center mt-3">
                                <label class="text_color_chineserelationhoroscope">Mijn geliefde is een ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <label>
                                    <input class="text_color_chineserelationhoroscope form-radio" type="radio" name="geliefde" value="man"> Man
                                </label>
                                <label>
                                    <input class="text_color_chineserelationhoroscope form-radio" type="radio" name="geliefde" value="vrouw"> Vrouw
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <?php
                                ...
                                foreach ($zodiacs as $zodiac_name => $image_path) {
                                    ...
                                    echo '    <div class="card shadower background_gradient_chineserelationhoroscope" style="cursor:pointer" onclick="startpayment(\'' . $zodiac_name . '\')">';
                                    ...
                                    echo '            <div style="font-weight:bold" class="textsize_chineserelationhoroscope font text_color_chineserelationhoroscope">' . ucfirst($zodiac_name) . '</div>';
                                    echo '        </div>';
                                    echo '    </div>';
                                    echo '</div>';
                                }
                ...
                <div class="col-12 text-center" id="chineserelation_loader" style="display:none">
            ...
            <div id="chineserelationhoroscope_box" style="max-height:500px;overflow-y:auto;display:none;border-radius:10px;margin-top:20px;margin-bottom:20px;" class="row">
                <div style="border-radius:10px;">
                    <div class="theme_color_chineserelationhoroscope text-center headersize_chineserelation mt-2" style="font-size:25px;!important;text-weight:bold">Je chinese jaarhoroscoop is klaar!</div>
                    <div class="col-md-6 offset-4 textsize_chineserelationhoroscope text_color_chineserelationhoroscope mt-3">Bekijk deze nu via onderstaande knop:</div>
                    <div class="row">
                        <div class="col-md-10 text-end mt-4">
                            <button id="resultbutton_chineserelationhoroscope" class="textsize_chineserelationhoroscope2023 font btn btn-outline text_color_chineserelationhoroscope" style="width:80%;">
                                <span class="textsize_chineserelationhoroscope" style="color:white!important;">BEKIJK DE CHINESE RELATIEHOROSCOOP</span>
                            </button>
                        </div> 
                        <div class="col-md-2 mt-4">
                            <button type="button" onclick="location.reload();" class="btn btn-outline-dark" style="width:50%">
                            <span class="textsize_chineserelationhoroscope"><i class="fa-solid fa-rotate-right fa2x"></i></span>
                            </button>
                        </div>                    
                    </div>
                </div>
        ...
        <script>
            ...
            function reset_chineseyear(){

                jQuery('#chineserelationhoroscope_box').hide();
                jQuery('#chineserelationhoroscope_box').css('opacity', '0');
                jQuery('#chineserelationhoroscope_box').css('display', 'none');
                jQuery('#chineserelation_primescreen').show();
            }
            ...
            jQuery(document).ready(function() {
                ...
                var test = getsettings(
                    jQuery, 
                    token,
                    21, 
                    'chineserelationhoroscope', 
                    'chineserelationcontainer', 
                    'font_chineseyear', 
                );
            ...
            function startpayment(attribute){

                var geliefde = jQuery("input[name=geliefde]:checked").val();

                if(geliefde != 'man' && geliefde != 'vrouw'){

                    alert('Vergeet niet het geslacht van uw partner te kiezen.')
                    return false;
                }

                attribute = attribute + ',' + geliefde;
            ...
            var paymentWindow = window.open('', '_blank');
                    ...
                    var returlurl = 'https://astromedia-business.nl/return?t=' + token + '&attr=' + attribute + '&host=' + host + '&pid=' + 21;
            ...
            jQuery("#resultbutton_chineserelationhoroscope").on('click', function() {
...
<?php
    ...
    add_shortcode('astro_chinese_relation_horoscope', 'chineserelationhoroscope');
?>